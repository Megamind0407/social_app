...
const Features = () => {
    return (
        <section className="features py-14 text-center dark:bg-slate-950">
            <h2 className="text-4xl font-extrabold mb-10 dark:text-slate-300" style={{fontFamily: "Dancing Script, cursive"}}>Why Hobbyly?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
                <div className="feature bg-white dark:bg-slate-800 dark:text-slate-300 p-8 rounded-lg shadow-lg hover:shadow-2xl transition duration-30 dark:hover:shadow-lg dark:hover:shadow-slate-900">
                ...
                <div className="feature bg-white dark:bg-slate-800  dark:text-slate-300 p-8 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 dark:hover:shadow-slate-900">
